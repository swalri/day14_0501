...
public class container extends Thread {
	...
	public void containerstop() {
		...
		int end_hour = (int) (end/(1000*60*60)%24);
...
//		System.out.print(end_hour-start_hour+"시 ");
//		System.out.print(end_min-start_min+"분 ");
//		System.out.println(end_sec-start_sec+"초");
		System.out.println(end);
		System.out.print(end_hour+"시 ");
		System.out.print(end_min+"분 ");
		System.out.println(end_sec+"초");
